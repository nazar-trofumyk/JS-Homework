...
function stringToarray(strSecond) {
   if (strSecond){
       let split =strSecond.split(' ')
       return split
   }
...
let mapedNumbers = numbers.map(number => number + '')
...
function sortNums(array,direction){
 ...
 if (direction === 'descending'){
     let sortedNumbers = array.sort((a,b)=>b-a)
     return sortedNumbers
 }
}
...
let sassElement =coursesArray.filter(item =>item.modules.includes('sass'))
console.log(sassElement)
